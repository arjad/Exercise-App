...
public class notification extends AppCompatActivity
{
    ...
    {
        String daysList[] = {"Your Exercise Timings", "New Features", "Personal Trainers Info "};

        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_notification);

        //recycler vire like list started
        ListView simpleList = (ListView) findViewById(R.id.simpleListView);
        ArrayAdapter<String> arrayAdapter =
                new ArrayAdapter<String>(this, R.layout.activity_recycleview, R.id.textView, daysList);
        ...
        simpleList.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(getApplicationContext(),"Launching Soon", Toast.LENGTH_SHORT).show();
            }
        });
        //recycler vieew ends
        ...
        button_update = (ImageView) findViewById(R.id.update);
    ...
    public void sendNotification() {
        ...
        notifyBuilder.addAction(R.drawable.logocircle,
    ...
    public void updateNotification() {
        ...
        Bitmap androidImage = BitmapFactory
                .decodeResource(getResources(), R.drawable.logocircle);
